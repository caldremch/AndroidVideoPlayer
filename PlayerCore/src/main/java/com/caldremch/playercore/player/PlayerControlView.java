...
public class PlayerControlView extends FrameLayout {
  ...
  private final View playScreenFullButton;
  ...
  public PlayerControlView(
    ...
    int controllerLayoutId = R.layout.user_control;
    ...
    playScreenFullButton = findViewById(R.id.exo_fullscreen);
    if (playScreenFullButton != null) {
      playScreenFullButton.setOnClickListener(componentListener);
    }
  ...
  private final class ComponentListener
    ...
    public void onClick(View view) {
      if (player != null) {
        if (nextButton == view) {
          next();
        }else if (playScreenFullButton == view) {
          if (fullScreenListener!=null){
            fullScreenListener.onClick(view);
          }
