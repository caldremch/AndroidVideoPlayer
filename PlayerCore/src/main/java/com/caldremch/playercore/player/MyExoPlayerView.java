 ...
 */
public class MyExoPlayerView extends FrameLayout implements AdsLoader.AdViewProvider {
    ...
    public MyExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (customController != null) {
            ...
            //自定义用户控制布局模式下， 支持全屏监听
            this.controller.setFullScreenListener(new FullScreenListener(){
                @Override
                public void onClick(View view) {
                    Log.d("caldremch", "自定义布局");
