...
public final class LiveThumbView extends FrameLayout {
    public LiveThumbView(@NonNull Context context) {
        super(context);
    }

    public LiveThumbView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public LiveThumbView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
